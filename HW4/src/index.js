...
const mapUrl =
  "https://gist.githubusercontent.com/hogwild/6784f0d85e8837b9926c184c65ca8ed0/raw/2040d6883cf822817e34b5bda885348ec6214572/jerseyCity_geojson.json";
    ...
    <div>
      ...
      <svg width={WIDTH} height={HEIGHT}>
        <g>
          ...
          />
          <SymmetricBarChart
            offsetX={margin.left + innerWidth / 2}
            offsetY={margin.top}
            data={data}
            height={(innerHeight - margin.gap) / 2}
            width={(innerWidth - margin.gap) / 2}
            selectedStation={selectedStation}
            setSelectedStation={setSelectedStation}
          />
        ...
        <Tooltip
          d={selectedPoint}
          stationYearData={stationYearData}
          left={margin.left + innerWidth / 2}
          top={margin.top + 40 + innerHeight / 2}
          height={(innerHeight - margin.gap) / 2}
          width={(innerWidth - margin.gap) / 2}
        />
      </svg>
